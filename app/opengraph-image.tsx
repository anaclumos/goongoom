...
import { DEFAULT_SIGNATURE_COLOR, SIGNATURE_COLORS } from '@/lib/colors/signature-colors'
...
export default async function Image() {
  ...
  return new ImageResponse(
    ...
    >
      <img alt={t('logoAlt')} height={260} src={logoBase64} style={{ borderRadius: '52px' }} width={260} />
      ...
      >
        ...
        <div style={{ fontSize: '42px', color: isDark ? '#9CA3AF' : '#6B7280' }}>{t('tagline')}</div>
      </div>
