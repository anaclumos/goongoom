    ...
    <div className="relative overflow-hidden py-24">
      <div className="mx-auto max-w-5xl px-6">
        <div className="rounded-2xl border border-border/60 bg-muted/30 p-8 text-center sm:p-12">
          <div className="mb-8 inline-flex items-center justify-center rounded-full border border-emerald-200/60 bg-background p-3 text-emerald-700 dark:border-emerald-500/20 dark:text-emerald-300">
