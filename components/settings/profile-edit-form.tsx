...
const SECURITY_ICONS: Record<string, typeof AnonymousIcon> = {
  anyone: AnonymousIcon,
  verified_anonymous: UserIcon,
  public_only: UserMultipleIcon,
}
      ...
      <Card>
        <CardContent className="space-y-4">
          ...
          <Field>
            ...
            <Textarea
              className="min-h-24 resize-none rounded-xl border border-border/50 bg-background transition-all focus:border-ring focus:ring-2 focus:ring-ring/20"
              id="bio"
              name="bio"
                    ...
                    <div className="flex items-center gap-2" key={row.id}>
                      <div className="relative flex-1">
                        ...
                        <Input
                          autoCapitalize="none"
                          autoCorrect="off"
                          className="min-h-11 rounded-xl border border-border/50 bg-background pl-10 transition-all focus:border-ring focus:ring-2 focus:ring-ring/20"
