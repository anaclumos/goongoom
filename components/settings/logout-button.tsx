  ...
  return (
    ...
    >
      <div className="flex size-8 items-center justify-center rounded-full bg-muted/50 transition-colors">
        <HugeiconsIcon className="size-4 text-muted-foreground transition-colors" icon={Logout01Icon} strokeWidth={2} />
      </div>
      <span className="flex-1 font-medium text-muted-foreground text-sm transition-colors">{t('logout')}</span>
      <HugeiconsIcon
