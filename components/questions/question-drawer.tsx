    ...
    <div className="space-y-6 py-4">
      <div className="rounded-xl border border-border/50 bg-muted/30 p-6 text-center">
        <div className="mx-auto mb-4 flex size-14 items-center justify-center rounded-full bg-primary/20">
          <HugeiconsIcon className="size-7 text-primary" icon={LockIcon} strokeWidth={2} />
        </div>
      ...
      <div className="flex gap-3">
        <PasskeySignInButton>
          <Button className="h-14 flex-1 rounded-xl font-semibold" size="lg" variant="outline">
            {tCommon('login')}
          </Button>
        </PasskeySignInButton>
...
function QuestionTypeSelector({
  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <button
        className={`group flex flex-col items-center justify-center gap-2 rounded-xl border border-border/50 bg-background p-4 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ${
          canAskAnonymously
            ? `cursor-pointer ${
                isAnonymous ? 'border-primary/50 bg-primary/5 ring-2 ring-primary/10' : 'border-border/50'
              }`
        ...
        type="button"
      >
        <Avatar className={`size-12 ring-2 ring-background transition-all ${isAnonymous ? 'ring-primary/20' : ''}`}>
        ...
        <div className="space-y-1 text-center">
          ...
          <p
            className={`font-medium text-xs leading-relaxed ${
              isAnonymous ? 'text-primary' : 'text-muted-foreground/70'
            }`}
          >
      ...
      <button
        className={`group flex flex-col items-center justify-center gap-2 rounded-xl border border-border/50 bg-background p-4 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ${
          canAskPublic
            ? `cursor-pointer ${
                isAnonymous ? 'border-border/50' : 'border-primary/50 bg-primary/5 ring-2 ring-primary/10'
              }`
            : 'cursor-not-allowed border-border/20 opacity-50'
        }`}
      ...
      >
        ...
        <div className="space-y-1 text-center">
          ...
          <p
            className={`font-medium text-xs leading-relaxed ${
              isAnonymous ? 'text-muted-foreground/70' : 'text-primary'
            }`}
          >
