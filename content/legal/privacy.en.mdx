...
| **Sentry, Inc.**    | Error monitoring, performance tracking, session replay, and service stability analysis | USA              | Transmission via network upon service use            | IP address, device info, location data, user actions, error data, performance data, session replay recordings, etc. | Until service withdrawal or termination of entrustment contract |
...
2. Previous versions of the Privacy Policy can be found [here](https://github.com/goongoom/goongoom/commits/master/content/legal).

## 12. Effective Date

- This Privacy Policy is effective from **January 26, 2026**.
